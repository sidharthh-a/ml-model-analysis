...
Analyze polynomial curve fitting with respect to bias–variance tradeoff and overfitting

Evaluate memory usage and performance characteristics of machine learning workflows
...
Study of underfitting vs overfitting
...
Identification of memory bottlenecks
...
Ability to analyze ML systems beyond raw accuracy metrics

Exposure to resource-aware ML development
...
git clone https://github.com/sidharthh-a/ml-model-analysis.git
cd ml-model-analysis
...
Datasets used are either synthetic or lightweight for reproducibility.
